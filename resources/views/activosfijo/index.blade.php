                ...
                <tbody>
                    @foreach ($activosfijo as $activo)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('activosfijo.show', $activo->id) }}"
                                    class="btn btn-warning btn-sm text-light rounded-pill" data-toggle="modal" data-target="#myModal">
                                    ...
                                    <form action="{{route('activosfijo.reporte', $activo->id)}}" method="POST">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                              ...
                                              <br>
                                              <div class="checkbox">
                                                    <input type="checkbox" name="activo" value="true" > Datos del Activo <br>
