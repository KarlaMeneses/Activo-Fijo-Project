                ...
                <tr>
                    ...
                    <td>
                        <form action="{{ route('notasventa.destroy', $nota) }}" method="post">
                            <a class="btn btn-warning btn-sm text-light rounded-pill" href="{{ route('notasventa.show', $nota->id) }}">
                                <i class="fas fa-eye"></i></a>

                            <a class="btn btn-primary btn-sm text-light rounded-pill" href="{{ route('notasventa.edit', $nota) }}">
                    ...
                    <td>
                        <a class="btn btn-info btn-sm text-light rounded-pill" href="{{ route('notasventa.reportehtml', $nota->id) }}">
                        ...
                        <a class="btn btn-warning btn-sm text-light rounded-pill" href="{{ route('notasventa.reporte', $nota->id) }}">
