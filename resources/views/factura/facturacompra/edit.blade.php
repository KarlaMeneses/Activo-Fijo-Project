        ...
        <form action="{{ route('factura.facturacompra.update', $factura->id ) }}" method="post" novalidate>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="date" name="fechaemitida" class="form-control" value="{{ $factura->fechaemitida }}" required>

                    <label for="formapago">Forma de Pago</label>
                    <input type="text" name="formapago" class="form-control" value="{{ $factura->formapago }}" required>
