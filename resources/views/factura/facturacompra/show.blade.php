...
<div class="card-header text-center">
    <h3><b>Ver Factura De Compra</b></h3>
</div>
@stop
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" value="{{ $factura->vendedor }}" disabled>
                                </div>
                            </div>
                            ...
                            <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" value="  {{ $factura->direccion }}" disabled>
                                </div>
                            </div>
                            <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                                <div class="form-group">
                                    <label>Email: </label>
                                    <input class="form-control" value="  {{ $factura->email }}" disabled>
                                </div>
                            </div>
