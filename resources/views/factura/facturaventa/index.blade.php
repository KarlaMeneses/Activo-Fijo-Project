...
@section('content')
    ...
    <div class="card">
        <div class="card-body " style="overflow-x: scroll">
            <table class="table table-striped table-bordered shadow-lg mt-4 " id="factura.facturaventa" style="width:100%">
                <thead class="bg-dark">
                    <tr>
                        <th scope="col">ID</th>
                    ...
                    @foreach ($facturas as $factura)
                        <tr>
                            ...
                            <td>
                                ...
                                href="{{ route('factura.facturaventa.reportehtml', $factura->id) }}">
...
@section('js')
    ...
    <script>
        ...
        $('#factura.facturaventa').DataTable();
        } );
    </script>
@stop
