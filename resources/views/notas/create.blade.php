            ...
            <form action="{{ route('notas.store') }}" method="post">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="direccion" class="form-control" maxlength="30" size="0"
                            pattern="{5,30}" placeholder="dirección" required>
                        @error('direccion')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror

                        <label for="telefono">Telefono:</label>
                        <input type="tel" name="telefono" class="form-control" size="0" maxlength="9"
                            pattern="[0-9-+()]{6,9}" placeholder="+591XXXXXXXXX" require>
                        @error('telefono')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
