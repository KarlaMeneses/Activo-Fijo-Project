...
<div class="card">
    <div class="card-header">
        <a href="{{ route('notas.create') }}" class="btn btn-primary btb-sm"> <i class="fas fa-bookmark"></i> Crear nota
            de compra</a>
    </div>
</div>
        ...
        <table class="table table-striped shadow-lg mt-4" id="notas" style="width:100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-info btn-sm text-light rounded-pill" href="{{ route('notas.reportehtml', $nota->id) }}">
                        ...
                        <a class="btn btn-warning btn-sm text-light rounded-pill" href="{{ route('notas.reporte', $nota->id) }}">
